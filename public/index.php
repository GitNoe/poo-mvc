...
//Inicio sesión para poder traspasar variables entre páginas
session_start();

//Incluyo los controllers que voy a utilizar para que seran cargados por Autoload
...
function autoload($clase,$dir=null){
    ...
    foreach (scandir($dir) as $file){
        //Si es un directorio (y no es de sistema) accedo y busco la clase dentro de él
