...
class UsuarioController{
    ...
    public function entrar(){
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            $campo_contraseña = filter_input(INPUT_POST, "contraseña", FILTER_SANITIZE_STRING);
            ...
            if ($usuario){
                ...
                if (password_verify($campo_contraseña,$usuario->contraseña)) {
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $cambiar_contraseña = (filter_input(INPUT_POST, 'cambiar_contraseña', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;

            //Encripto la contraseña
            $contraseña_encriptada = ($contraseña) ? password_hash($contraseña,  PASSWORD_BCRYPT, ['cost'=>12]) : "";

            if ($id == "nuevo"){
                //Creo un nuevo usuario
                $this->db->exec("INSERT INTO usuarios (usuario, contraseña, noticias, usuarios) VALUES ('$usuario','$contraseña_encriptada',$noticias,$usuarios)");
                //Mensaje y redirección
                ...
                ($cambiar_contraseña) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',contraseña='$contraseña_encriptada',noticias=$noticias,usuarios=$usuarios WHERE id='$id'") :
